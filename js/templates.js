...
if(location.pathname.substr(location.pathname.lastIndexOf('/') + 1) == 'index.html') {ind = 'active'; titleembelish = ''; }
else if (location.pathname.substr(location.pathname.lastIndexOf('/') + 1) == 'about.html') {abt = 'active'; titleembelish = ' - About';} 
else if (location.pathname.substr(location.pathname.lastIndexOf('/') + 1) == 'contact.html') {cont = 'active'; titleembelish = ' - Contact';}
else if (location.pathname.substr(location.pathname.lastIndexOf('/') + 1) == 'guessthestory.html') {funstuff = 'active'; titleembelish = ' - FunStuff';}
